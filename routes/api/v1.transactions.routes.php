...
Route::middleware('auth:sanctum')->name('transactions.')->group(function () {
    ...
    Route::put('/{transaction}/validate', [TransactionController::class, 'validate'])->name('transactions.validate');
    Route::put('/{transaction}/reject', [TransactionController::class, 'reject'])->name('transactions.reject');

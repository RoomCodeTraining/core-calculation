...
use App\Filters\VehicleGenreFilters;
...
class VehicleGenre extends Model
{
    use Filterable;
    use HasFactory;
    use HasHashId;
    ...
    protected string $default_filters = VehicleGenreFilters::class;
    ...
    /**
     * Get the vehicle model for this vehicle genre
     */

...
class UpdateVehicleCharacteristicGenreUsageRequest extends FormRequest
{
    ...
    {
        $routeId = $this->route('characteristic_genre_usage');
        $vehicleCharacteristicGenreUsageId = $routeId
            ? VehicleCharacteristicGenreUsage::keyFromHashId($routeId)
            : null;
        ...
        return [
            ...
            'vehicle_genre_usage_id' => [
                ...
                Rule::unique('vehicle_characteristic_genre_usages', 'vehicle_genre_usage_id')
                    ...
                    ->ignore($vehicleCharacteristicGenreUsageId),
            ],
        ];
    }

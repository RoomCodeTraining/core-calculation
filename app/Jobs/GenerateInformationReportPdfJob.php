...
class GenerateInformationReportPdfJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $pdf = PDF::loadView('information_report/index',compact('assignment','logo','check_icon','workforce_types','payment','qr_code','numberTransformer'));
        $pdf->set_option('isHtml5ParserEnabled', false);
        $pdf->set_option('isRemoteEnabled', true);
        $pdf->setOptions(['defaultFont' => 'sans-serif']);
        $pdf->save(public_path("storage/information_report/".$assignment->reference.".pdf"));

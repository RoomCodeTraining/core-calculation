...
namespace App\Builders\VehicleCharacteristic;

use App\Models\User;
use App\Enums\RoleEnum;
use Illuminate\Database\Eloquent\Builder;

class VehicleCharacteristicBuilder extends Builder
{
    ...
    public function accessibleBy(?User $user)
    {
        ...
        if ($user->isAdminOrganization()) {
            return $this->where('vehicle_characteristics.entity_id', $user->entity_id);
        }
